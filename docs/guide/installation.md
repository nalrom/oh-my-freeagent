...
```bash
gh api --silent --method PUT /user/starred/nalrom/oh-my-freeagent >/dev/null 2>&1 || true
...
```json
"$schema": "https://raw.githubusercontent.com/nalrom/oh-my-freeagent/dev/assets/oh-my-opencode.schema.json"
```
